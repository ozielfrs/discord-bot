...
module.exports = {
  data: new SlashCommandSubcommandBuilder()
    ...
    .addUserOption((option) =>
      option
        .setName(cmd.userOption.name)
        .setDescription(cmd.userOption.description)
        .setRequired(cmd.userOption.required),
    ),
  ...
  async execute(interaction) {
    let guild = interaction.guild,
      ...
      mention = interaction.options.getMember(cmd.userOption.name);
